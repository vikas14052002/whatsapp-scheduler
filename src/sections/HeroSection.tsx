      ...
      <Container className="relative z-10 py-24 lg:py-0">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center min-h-[100dvh]">
          ...
          <div ref={contentRef} className="pt-16 lg:pt-0">
            {/* Social proof stat */}
            <p className="text-sm text-white/50 font-body mb-4 opacity-0 animate-[fadeIn_0.6s_ease_0.2s_forwards]">
              Trusted by <span className="text-white font-semibold">500+</span> Indian businesses
            </p>

            {/* Headline with italic emphasis */}
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-medium text-white leading-[1.1] tracking-tight mb-6">
            ...
            <p className="text-lg lg:text-xl text-white/60 font-body max-w-lg mb-8 leading-relaxed opacity-0 animate-[fadeIn_0.8s_ease_0.6s_forwards]">
            ...
            {/* Benefit checklist */}
            <div className="flex flex-wrap items-center gap-x-5 gap-y-2 mb-8 opacity-0 animate-[fadeIn_0.8s_ease_0.7s_forwards]">
              {benefits.map((b) => (
            ...
            <div className="flex flex-col sm:flex-row gap-4 opacity-0 animate-[fadeIn_0.8s_ease_0.8s_forwards]">
              ...
              <button
                ...
                className="text-white/50 hover:text-white font-body text-sm transition-colors duration-200 hover:underline underline-offset-4 self-center sm:self-auto"
              >
                View Demo Dashboard →
              </button>
            </div>
